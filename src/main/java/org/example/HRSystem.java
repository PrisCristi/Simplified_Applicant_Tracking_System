...
import org.example.hr.Recruter;
...
public class HRSystem {
    public static final String reportFile = "/Users/priscilasantos/Documents/StartSteps/Simplified_Applicant_Tracking_System/src/main/java/org/example/resources/reportFile.txt";
    ...
    public Map<String, Long> applicantsCountPerStatus() {
        Map<String, Long> countPerStatus = new HashMap<>();
        for (Applicant applicant : applicants){
            String status = applicant.getStatus();
            countPerStatus.put(status,countPerStatus.getOrDefault(status, 0L) +1);
